...
DROP TRIGGER IF EXISTS on_user_role_changed ON public.user_roles CASCADE;
DROP FUNCTION IF EXISTS public.has_permission(uuid, app_permission) CASCADE;
DROP FUNCTION IF EXISTS public.has_role(uuid, app_role) CASCADE;
DROP FUNCTION IF EXISTS public.assign_role_permissions(uuid, app_role) CASCADE;
DROP FUNCTION IF EXISTS public.handle_role_assignment() CASCADE;
