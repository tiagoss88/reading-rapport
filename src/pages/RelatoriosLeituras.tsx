...
export default function RelatoriosLeituras() {
  ...
  return (
    <Layout title="Relatórios de Leituras">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">📊 Relatórios de Leituras</h1>
          <p className="text-muted-foreground mt-1">
            Relatórios relacionados a leituras e condomínios
          </p>
        </div>
