...
export type TipoRelatorio = 'condominios_competencia' | 'rdo_servicos' | 'cadastro_condominios_uf' | 'cadastro_condominios_uf_completo' | 'condominios_georreferenciados' | 'coletas_sem_pendencia';
